.PHONY: build build-proxy build-warden test vet lint docker-build docker-push help
...
help:
	@echo "Targets: build build-proxy build-warden test vet lint docker-build docker-push helm-lint"
